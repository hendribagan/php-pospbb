    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    <li <?echo $current=='beranda' ? 'class="active"' : '';?>><a class="brand" href="<?=active_module_url();?>">POSPBB<?//=strtoupper(active_module());?></a></li>
                    ...
                    <li class="dropdown <?echo $current=='stts' ? 'active' : '';?>">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?=active_module_url();?>range_thn">Cetak STTS - Per Tahun</a></li>
                    ...
                    <li class="dropdown <?echo $current=='laporan' ? 'active' : '';?>">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?=active_module_url();?>laporan">Laporan Harian</a></li>
                            <li><a href="<?=active_module_url();?>lapbatal">Laporan Pembatalan</a></li>
